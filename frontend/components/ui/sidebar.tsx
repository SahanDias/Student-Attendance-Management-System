...
>(({ className, showIcon = false, ...props }, ref) => {
  // Pseudo-random width between 50 and 90%, derived from useId() rather
  // than Math.random() so the value is identical on the server and during
  // client hydration (Math.random() would differ between the two renders
  // and trigger a hydration mismatch on this inline style).
